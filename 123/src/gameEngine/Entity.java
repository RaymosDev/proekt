package gameEngine; // Объявление пакета, в котором находится класс Entity.

/*  Класс Entity представляет собой абстрактный объект в игровом движке, 
    который имеет коллайдер для обработки столкновений с другими сущностями. 
...
public abstract class Entity extends SceneObject { // Объявление абстрактного класса Entity, наследующего от SceneObject.
