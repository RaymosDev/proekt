...
public class Marauder extends Entity implements DamagableEntity {
    ...
    private static Image LARGE_ORB;
    private static Image SMALL_ORB;
    ...
    public static void updateDimensions() {
        ...
        ResolutionConfig.Resolution largeOrbSize = ResolutionConfig.getLargeOrbSize();
        LARGE_ORB_WIDTH = largeOrbSize.width;
        LARGE_ORB_HEIGHT = largeOrbSize.height;

        ResolutionConfig.Resolution smallOrbSize = ResolutionConfig.getSmallOrbSize();
